...
public class FuelUpTrigger : MonoBehaviour
{
	public MissionManager missionManager;

	[Header("Settings")]
	[SerializeField] private TMP_FontAsset font;
	[SerializeField] private GameObject fuelUpMission;
	...
	private void OnTriggerEnter(Collider other)
	{
		...
		{
			UIMissionManager.Instance.ShowMissionText("ONLY TANKER TRUCK", 1.0f, 50, font);
		}
	}
}
